(function () {
   ...
   var GapmiteGenerator = yeoman.generators.Base.extend({
      init: function () {
         ...
         // when generator has ended do some final work
            ...
            if (!this.options['skip-install']) {
               this.installDependencies({
                  ...
                  callback: function () {
                     ...
                     child = cprocess.spawn('grunt', ['createapp']);
      ...
      askFor: function () {
         ...
         this.log(chalk.magenta('Gapmite generator will create a base project for hybrid mobile apps using ' +
         'Backbone.js, Cordova/Phonegap, Browserify, ?????'));
      ...
      app: function () {
         this.mkdir('app');
         this.directory('app-template', 'app');
